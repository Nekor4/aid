...
namespace Aid
{
    ...
    static class SceneAutoLoader
    {
        ...
        private static void SelectMasterScene()
        {
            ...
            masterScene = masterScene.Replace(
                Application.dataPath,
                "Assets"); //project relative instead of absolute path
        ...
        private static string cEditorPrefLoadMasterOnPlay => $"{GetProjectName()}.SceneAutoLoader.LoadMasterOnPlay";

        private static string cEditorPrefMasterScene => $"{GetProjectName()}.SceneAutoLoader.MasterScene";

        private static string cEditorPrefPreviousScene => $"{GetProjectName()}.SceneAutoLoader.PreviousScene";
